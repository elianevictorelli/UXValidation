...
write.csv(corrM, file.path(output_dir, "generatedData-CFA/items_correlations.csv"))


## Save as PDF
this_file <- file.path(output_dir, "generatedPlots-CFA/items-correlation-plot.pdf")
...
for (letter in stimuli_letters) {
  ...
  for (nb_f in nbs_factors) {
    ...
    tryCatch({
      ...
      write.csv(c_mat, file.path(output_dir, paste0("generatedData-CFA/corr_matrix_", letter, ".csv")))
